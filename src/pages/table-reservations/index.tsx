...
import { useRoqClient, useTableReservationFindManyWithCount } from 'lib/roq';
...
export function TableReservationListPage(props: TableReservationListPageProps) {
  ...
  const { data, error, isLoading, mutate } = useTableReservationFindManyWithCount({
  ...
  const handleDelete = async (id: string) => {
    setDeleteError(null);
    try {
      await roqClient.table_reservation.delete({ where: { id } });
      await mutate();
    } catch (error) {
