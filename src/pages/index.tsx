  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience seamless dining with Restaurant Booking Engine. An innovative restaurant management app where customers reserve tables and employees manage reservations and menus."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience seamless dining with Restaurant Booking Engine. An innovative restaurant management app where customers reserve tables and employees manage reservations and menus.`}
            </Text>
            <Box
